...
func TestChildService_List_Success(t *testing.T) {
	...
	res, err := service.NewChildService(repo).List(domain.ChildListParams{Page: 1, PageSize: 20})
...
func TestChildService_List_ZeroPageNormalisedToOne(t *testing.T) {
	...
	service.NewChildService(repo).List(domain.ChildListParams{Page: 0, PageSize: 20})
...
func TestChildService_List_NegativePageNormalisedToOne(t *testing.T) {
	...
	service.NewChildService(repo).List(domain.ChildListParams{Page: -99, PageSize: 20})
	assert.Equal(t, 1, got)
}
...
func TestChildService_List_ZeroPageSizeNormalisedTo20(t *testing.T) {
	...
	service.NewChildService(repo).List(domain.ChildListParams{Page: 1, PageSize: 0})
...
func TestChildService_List_PageSizeOver100NormalisedTo20(t *testing.T) {
	...
	service.NewChildService(repo).List(domain.ChildListParams{Page: 1, PageSize: 101})
	assert.Equal(t, 20, got)
}
...
func TestChildService_List_PageSize100IsAllowed(t *testing.T) {
	...
	service.NewChildService(repo).List(domain.ChildListParams{Page: 1, PageSize: 100})
...
func TestChildService_List_BairroFilterPassedThrough(t *testing.T) {
	...
	service.NewChildService(repo).List(domain.ChildListParams{Page: 1, PageSize: 20, Bairro: "Copacabana"})
...
func TestChildService_List_ComAlertasFilterPassedThrough(t *testing.T) {
	...
	service.NewChildService(repo).List(domain.ChildListParams{Page: 1, PageSize: 20, ComAlertas: &val})
...
func TestChildService_List_RepoError(t *testing.T) {
	...
	_, err := service.NewChildService(repo).List(domain.ChildListParams{Page: 1, PageSize: 20})
	assert.Error(t, err)
}
...
func TestChildService_GetByID_Found(t *testing.T) {
	...
	c, err := service.NewChildService(repo).GetByID("C001")
	require.NoError(t, err)
...
func TestChildService_GetByID_RepoReturnsNil_MapsToErrNotFound(t *testing.T) {
	...
	_, err := service.NewChildService(repo).GetByID("MISSING")
...
func TestChildService_GetByID_RepoError_Propagated(t *testing.T) {
	...
	_, err := service.NewChildService(repo).GetByID("C001")
	assert.Error(t, err)
...
func TestChildService_MarkReviewed_Success(t *testing.T) {
	...
	err := service.NewChildService(repo).MarkReviewed("C001", "analista@prefeitura.rio")
...
func TestChildService_MarkReviewed_SqlErrNoRows_MapsToErrNotFound(t *testing.T) {
	...
	err := service.NewChildService(repo).MarkReviewed("MISSING", "analista")
	assert.ErrorIs(t, err, service.ErrNotFound)
}
...
func TestChildService_MarkReviewed_OtherError_Propagated(t *testing.T) {
	...
	err := service.NewChildService(repo).MarkReviewed("C001", "analista")
	assert.Error(t, err)
	assert.NotErrorIs(t, err, service.ErrNotFound)
}
...
func TestChildService_MarkReviewed_PassesReviewerThrough(t *testing.T) {
	...
	service.NewChildService(repo).MarkReviewed("C042", "tecnico@prefeitura.rio")
...
func TestChildService_Summary_Success(t *testing.T) {
	...
	got, err := service.NewChildService(repo).Summary()
	require.NoError(t, err)
...
func TestChildService_Summary_Error(t *testing.T) {
	...
	_, err := service.NewChildService(repo).Summary()
	assert.Error(t, err)
}
